        ...
        return (
          <div className="bg-gray-50 p-8 rounded-b-lg">
            <div className="bg-white shadow-md rounded-lg p-6 max-w-3xl mx-auto">
              <h3 className="text-xl font-semibold mb-4">Market Structure & Competitive Analysis</h3>
          ...
          <div className="bg-gray-50 p-8 rounded-b-lg">
            <div className="bg-white shadow-md rounded-lg overflow-hidden mx-auto">
              <div className="p-4 border-b border-gray-200">
                <h3 className="text-lg font-medium text-gray-800">Select M&A transactions in data security (cont'd)</h3>
              </div>
  ...
  return (
    <section className="py-20 bg-white">
      <div className="section-container">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-rooftop text-gray-900 mb-6">
        ...
        <motion.div
          ...
          className="bg-white shadow-md rounded-lg overflow-hidden max-w-6xl mx-auto"
        >
          {/* Tabs */}
